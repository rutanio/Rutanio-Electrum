...
class TestWalletKeystoreAddressIntegrityForMainnet(SequentialTestCase):
    ...
    def test_electrum_multisig_seed_standard(self, mock_write):
        ...
        # electrum-civx seed: ghost into match ivory badge robot record tackle radar elbow traffic loud
    ...
    def test_electrum_multisig_seed_segwit(self, mock_write):
        ...
        # electrum-civx seed: hedgehog sunset update estate number jungle amount piano friend donate upper wool
