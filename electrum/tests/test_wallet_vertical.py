...
from electrum_exos import storage, bitcoin, keystore, constants
...
class TestWalletKeystoreAddressIntegrityForMainnet(SequentialTestCase):
    ...
    def test_electrum_multisig_seed_standard(self, mock_write):
        ...
        # exos-electrum seed: ghost into match ivory badge robot record tackle radar elbow traffic loud
    ...
    def test_electrum_multisig_seed_segwit(self, mock_write):
        ...
        # exos-electrum seed: hedgehog sunset update estate number jungle amount piano friend donate upper wool
