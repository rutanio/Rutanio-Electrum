...
from electrum_rutanio.util import base_units_list
...
from electrum_rutanio import coinchooser
...
<SettingsDialog@Popup>
    id: settings
    title: _('Rutanio Electrum Settings')
    disable_pin: False
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for Rutanio amounts.")
