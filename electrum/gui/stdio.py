...
_ = lambda x:x
#from i18n import _
from electrum_civx import WalletStorage, Wallet
...
class ElectrumGui:
    ...
    def network_dialog(self):
        print("use 'electrum-civx setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-civx setconfig' to change your settings")
        return True
